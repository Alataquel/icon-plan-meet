  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-20 left-10 w-72 h-72 bg-[hsl(199_89%_48%/0.15)] rounded-full blur-3xl" />
        <div className="absolute top-40 right-20 w-96 h-96 bg-[hsl(142_76%_36%/0.12)] rounded-full blur-3xl" />
        <div className="absolute bottom-40 left-1/4 w-80 h-80 bg-primary/15 rounded-full blur-3xl" />
        <div className="absolute bottom-20 right-1/3 w-64 h-64 bg-[hsl(340_65%_60%/0.12)] rounded-full blur-3xl" />
      </div>
